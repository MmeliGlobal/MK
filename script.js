...
// ==================== DIRECT REST API FOR PRODUCT INSERT (BYPASSES CACHE) ====================
...
// ==================== ADMIN FUNCTIONS (using direct fetch for products) ====================
...
// ==================== ADD PRODUCT (USING DIRECT FETCH) ====================
async function addProduct() {
  ...
  // Ensure unique slug (simple check, can be improved)
  let finalSlug = slug;
  let counter = 1;
  ...
  try {
    ...
    const variantSku = `${finalSlug}-DEFAULT`;
...
async function updateProduct() {
  ...
  try {
    await updateProductDirect(editProductId, updatedProduct);
...
// ==================== QUOTATION FUNCTIONS (unchanged from your original) ====================
function setupQuotationForm() { /* your existing code – keep as is */ }
